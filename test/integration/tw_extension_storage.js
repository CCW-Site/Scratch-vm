...
// skip(' skip extension_storage for now, unsupported')
// return;
...
test('deserialize project with data', t => {
    ...
    vm.extensionManager.addBuiltinExtension('test1', test1Ext);
    vm.extensionManager.addBuiltinExtension('test2', test2Ext);
    vm.extensionManager.addBuiltinExtension('test3', test3Ext);
